...
namespace Infra
{
    ...
    public static class Impressao
    {
        public static void ImprimirOS(object _current)
        {
            ...
            PdfPCell cell_Protocolo = new PdfPCell(new Phrase($"PROTOCOLO: {(string)((DataRowView)bindingSourceImprimirOS.Current).Row["Protocolo"]}", new Font(iTextSharp.text.Font.NORMAL, 10/*, (int)System.Drawing.FontStyle.Bold*/)));
            ...
            //LINHA UM
            PdfPCell cell_Nome = new PdfPCell(new Phrase($"Cliente: {(string)((DataRowView)bindingSourceImprimirOS.Current).Row["NomeCompleto"]}", new Font(iTextSharp.text.Font.NORMAL, 8/*, (int)System.Drawing.FontStyle.Bold*/)));
            ...
            PdfPCell cell_CPF_CNPJ = new PdfPCell(new Phrase($"CPF/CNPJ: {(string)((DataRowView)bindingSourceImprimirOS.Current).Row["Cpf"]}", new Font(iTextSharp.text.Font.NORMAL, 8/*, (int)System.Drawing.FontStyle.Bold*/)));
            ...
            //LINHA DOIS
            PdfPCell cell_Cep = new PdfPCell(new Phrase($"Cep: {(string)((DataRowView)bindingSourceImprimirOS.Current).Row["Cep"]}", new Font(iTextSharp.text.Font.NORMAL, 8/*, (int)System.Drawing.FontStyle.Bold*/)));
            ...
            PdfPCell cell_Plano = new PdfPCell(new Phrase($"Plano: SEM PLANO", new Font(iTextSharp.text.Font.NORMAL, 8/*, (int)System.Drawing.FontStyle.Bold*/)));
            ...
            //LINHA TRES
            PdfPCell cell_Email = new PdfPCell(new Phrase($"E-mail: {(string)((DataRowView)bindingSourceImprimirOS.Current).Row["Email"]}", new Font(iTextSharp.text.Font.NORMAL, 8/*, (int)System.Drawing.FontStyle.Bold*/)));
            ...
            PdfPCell cell_Telefone = new PdfPCell(new Phrase($"Telefones: {(string)((DataRowView)bindingSourceImprimirOS.Current).Row["Telefone"]}, {(string)((DataRowView)bindingSourceImprimirOS.Current).Row["CelularUm"]}, {(string)((DataRowView)bindingSourceImprimirOS.Current).Row["CelularDois"]}", new Font(iTextSharp.text.Font.NORMAL, 8/*, (int)System.Drawing.FontStyle.Bold*/)));
            ...
            PdfPCell cell_Atendente = new PdfPCell(new Phrase($"Atendente: {(string)((DataRowView)bindingSourceImprimirOS.Current).Row["Atendente"]}", new Font(iTextSharp.text.Font.NORMAL, 8/*, (int)System.Drawing.FontStyle.Bold*/)));
            ...
            //LINHA QUATRO
            PdfPCell cell_Tipo = new PdfPCell(new Phrase($"Tipo: {(string)((DataRowView)bindingSourceImprimirOS.Current).Row["TipoChamado"]}", new Font(iTextSharp.text.Font.NORMAL, 8/*, (int)System.Drawing.FontStyle.Bold*/)));
            ...
            PdfPCell cell_Status = new PdfPCell(new Phrase($"Status: {(string)((DataRowView)bindingSourceImprimirOS.Current).Row["EstatusOS"]}", new Font(iTextSharp.text.Font.NORMAL, 8/*, (int)System.Drawing.FontStyle.Bold*/)));
            ...
            PdfPCell cell_LigarAntes = new PdfPCell(new Phrase($"Ligar Antes: {(string)((DataRowView)bindingSourceImprimirOS.Current).Row["LigarAntes"]}", new Font(iTextSharp.text.Font.NORMAL, 8/*, (int)System.Drawing.FontStyle.Bold*/)));
            ...
            PdfPCell cell_Abertura = new PdfPCell(new Phrase($"Abertura: {Convert.ToString(((DataRowView)bindingSourceImprimirOS.Current).Row["DataAbertura"]).Replace("00:00:00","")}", new Font(iTextSharp.text.Font.NORMAL, 8/*, (int)System.Drawing.FontStyle.Bold*/)));
            ...
            PdfPCell cell_Prazo = new PdfPCell(new Phrase($"Prazo: {Convert.ToString(((DataRowView)bindingSourceImprimirOS.Current).Row["DataPrazo"]).Replace("00:00:00","")}", new Font(iTextSharp.text.Font.NORMAL, 8/*, (int)System.Drawing.FontStyle.Bold*/)));
            ...
            PdfPCell cell_TecResponsavel = new PdfPCell(new Phrase($"Tec. Responsável: {(string)((DataRowView)bindingSourceImprimirOS.Current).Row["TecnicoResponsavel"]}", new Font(iTextSharp.text.Font.NORMAL, 8/*, (int)System.Drawing.FontStyle.Bold*/)));
            ...
            //LINHA CINCO
            PdfPCell cell_Descricao = new PdfPCell(new Phrase($"Descrição: {(string)((DataRowView)bindingSourceImprimirOS.Current).Row["Descricao"]}", new Font(iTextSharp.text.Font.NORMAL, 8/*, (int)System.Drawing.FontStyle.Bold*/)));
